...
return new class extends Migration
{
    ...
    {
        Schema::create('weather_provinces', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedBigInteger('province_id')->index()->comment('ID tỉnh/thành');
            ...
            $table->dateTime('target_time')->nullable()->comment('Thời điểm dữ liệu hướng tới (ví dụ: ngày mai)');
    ...
    {
        Schema::dropIfExists('weather_provinces');
    }
};
